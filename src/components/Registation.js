...
const Registation=()=>{
  const navigate = useNavigate();
   ...
   const {email, full_name,setFullName,setEmail,password, setPassword,showRegistration, setShowRegistration,errorMessage, setErrorMessage,userId,setUserId} = context
